...
import { generateStyleLink } from "@/app/actions/styles";

interface GenerateStyleLinkModalProps {
    isOpen: boolean;
    onClose: () => void;
    quizId: string;
    quizTitle: string;
...
export function GenerateStyleLinkModal({ isOpen, onClose, quizId, quizTitle, onSuccess }: GenerateStyleLinkModalProps) {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const result = await generateStyleLink(quizId, {
                    ...
                    <div className="flex items-start justify-between">
                        <div>
                            <h2 className="text-xl font-semibold text-white">
                                {generatedLink ? 'Link wygenerowany!' : 'Wyślij quiz stylów'}
                            </h2>
                    ...
                    {generatedLink ? (
                        <div className="space-y-4">
                            <div className="bg-[#1B1B1B] rounded-lg p-4">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-[14px] font-medium text-white">Link do quizu</span>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[14px] text-muted-foreground mt-1">
                                            ...
                                            Otrzymasz powiadomienie gdy klient wybierze swoje ulubione style.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-[#1B1B1B] rounded-lg p-4 text-[14px] text-muted-foreground">
                                <p>
                                    Po wyborze stylów przez klienta, link wygaśnie automatycznie po 24 godzinach.
                                    Klient nie będzie mógł edytować swoich wyborów.
                                </p>
                            </div>
                        </div>
                    )}
