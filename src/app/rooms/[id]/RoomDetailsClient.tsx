                ...
                <div className="flex-1 flex flex-col min-h-0">
                    ...
                    <div className="py-4 px-6 flex flex-col sm:flex-row items-center justify-between gap-4 shrink-0">
                        ...
                        <div className="flex items-center gap-2 w-full sm:w-auto overflow-x-auto no-scrollbar">
                            {activeTab === "Zadania" ? (
                                <>
                                    <Button variant="ghost" className="flex items-center gap-2 border border-dashed border-[#2A2A2A] hover:border-white/20 hover:bg-white/5 text-[#6E6E6E] hover:text-white px-5 py-3 rounded-lg text-sm font-medium transition-all whitespace-nowrap min-h-[48px]">
