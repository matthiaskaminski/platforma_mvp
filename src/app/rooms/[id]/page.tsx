...
const ROOM_IMG_PLACEHOLDER = "https://zotnacipqsjewlzofpga.supabase.co/storage/v1/object/public/Liru/526853319_1355299779932415_3850250429931914731_n.jpg";
    ...
    return (
        <div className="flex flex-col lg:flex-row h-full gap-3 w-full overflow-hidden">
            ...
            <div className="flex-1 flex flex-col min-w-0 h-full gap-3 pb-3 overflow-hidden">
                ...
                {/* 2. Main Content Container - No Background as requested */}
                <div className="flex-1 flex flex-col min-h-0">

                    {/* Tabs Header - Border aligned with content */}
                    ...
                    <div className="py-4 px-6 flex flex-col sm:flex-row items-center justify-between gap-4 shrink-0">
                        ...
                        <div className="flex items-center gap-2 w-full sm:w-auto overflow-x-auto no-scrollbar">
                            {activeTab === "Zadania" ? (
                                ...
                                // No buttons for these tabs as requested (or minimal)
                                <Button className="flex items-center gap-2 bg-[#1B1B1B] hover:bg-[#232323] text-muted-foreground hover:text-white px-5 py-3 rounded-lg text-sm font-medium transition-colors min-h-[48px]">
